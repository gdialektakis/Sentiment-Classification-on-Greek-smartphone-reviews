...
from keras.layers import Dense, Embedding, LSTM, Input, Bidirectional, Activation, Dropout
...
class LSTMNET:
    ...
    def run(self, df, X):
        ...
        if not self.use_embeddings:
            ...
            model.add(Embedding(vocab_size, 300, weights=[self.embedding_matrix], input_length=X.shape[1], trainable=False))
